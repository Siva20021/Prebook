...
function Header() {
  return (
    <div>
        <nav className="bg-[#A91079] text-blue-700 flex h-[50px] fixed w-[100%]">
                <div className='w-[20px]'></div> 
                <div><img alt="Header-logo" src="../images/prebook.jpeg" className='h-[40px] w-[130px] mt-[10px] rounded-[20px] mr-[150px]'/></div>           
                <input type="text" className=" hidden lg:block h-[30px] w-[300px] rounded-[20px] text-[30px] text-left focus:outline-none" placeholder='Search Movies'/>
                <ul className=' h-[30px] flex flex-row'>
                    ...
                    <li className='  hidden xl:block cursor-pointer text-[25px] ml-[15px] w-[200px] h-[30px] box-content hover:bg-yellow-400  rounded-[20px] pb-[5px] pl-[20px] drop-shadow-none'>Movies</li>
